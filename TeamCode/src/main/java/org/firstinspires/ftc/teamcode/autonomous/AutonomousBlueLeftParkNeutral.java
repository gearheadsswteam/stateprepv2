...
@Autonomous(name = "AutonomousBlueLeftParkNeutral", group = "BlueLeft")
public class AutonomousBlueLeftParkNeutral extends AbstractAutonomous {
    Pose2d dropPose = new Pose2d(33, 19, -2.05);
